...
Example usage:
```
Rscript import.R ---port 5432 --host localhost --password "my password" --key unique_db_key --desc "My Project YYYY-YYYY" database_name database_user /path/to/source_database 
```
...
Example usage:
```
Rscript export.R ---port 5432 --host localhost --password "my password" --schema eco database_name database_user /path/to/export_database.sqlite 
```
...
Example usage:
```
Rscript lpi_convert.R ---port 5432 --host localhost --password "my password" --cover --cover "indicator1, any; indicator2, top;" database_name database_user /path/to/lpi_calc/output.csv path/to/output
```
